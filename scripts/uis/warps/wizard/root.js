...
uiManager.addUI(versionData.uiNames.Warps.Wizard.Root, "meow mrrp nya mrrp", (player)=>{
    ...
    insertBackButton(form, "/scriptevent leafgui:ui_builder_create_ui_selector")
    form.button(`§aAutomatic\n§7Use your current location`, `textures/azalea_icons/other/location_character`, (player)=>{
        uiManager.open(player, versionData.uiNames.Warps.Wizard.Automatic)
    })
    form.button(`§bManual\n§7Manually input coordinates`, `textures/azalea_icons/other/location_hand`, (player)=>{
