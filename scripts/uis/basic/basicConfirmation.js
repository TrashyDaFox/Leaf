...
import { NUT_UI_DISABLE_VERTICAL_SIZE_KEY, NUT_UI_LEFT_HALF, NUT_UI_RIGHT_HALF, NUT_UI_TAG } from "../preset_browser/nutUIConsts";
...
uiManager.addUI(config.uiNames.Basic.Confirmation, "Basic Confirmation UI", (player, actionLabel, actionYes, actionNo)=>{
    ...
    form.button(`${NUT_UI_RIGHT_HALF}${NUT_UI_DISABLE_VERTICAL_SIZE_KEY}§r§aYes`, icons.resolve("^textures/ui/confirm"), player=>{
    ...
    form.button(`${NUT_UI_LEFT_HALF}§r§cNo`, icons.resolve("^textures/ui/cancel"), player=>{
