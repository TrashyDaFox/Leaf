...
uiManager.addUI(config.uiNames.Config.Misc, "Misc Config", (player)=>{
    if(!player.hasTag("old-config")) return player.runCommand("scriptevent leaf:open nutui/misc")
