...
uiManager.addUI(versionData.uiNames.Zones.Edit, "A", (player, id)=>{
    ...
    form.button(`§eEdit Properites\n§7Edit area and priority`, null, (player)=>{
    ...
    form.button(`§cDelete\n§7Delete this zone`, `textures/azalea_icons/Delete`, (player)=>{
        uiManager.open(player, versionData.uiNames.Basic.Confirmation, "Are you sure you want to delete this zone?", ()=>{
