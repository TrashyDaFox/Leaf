...
import { NUT_UI_ALT, NUT_UI_THEMED } from "../../uis/preset_browser/nutUIConsts";
...
class NormalFormOpener {
    ...
    open(player, data, ...args) {
        ...
        if(data.layout == 4) pre = `§f§0§0${themString}§r`
